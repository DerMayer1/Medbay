        ...
        <tbody className="divide-y divide-[#ededed]">
          {localLeads.map((lead) => (
            <tr key={String(lead.id)}>
              <td className="px-4 py-3 font-medium text-[#262626]">{String(lead.name || "Unnamed patient")}</td>
              <td className="px-4 py-3 text-[#737373]">{String(lead.contact || lead.phone || lead.email || "Not provided")}</td>
              ...
              <td className="px-4 py-3">
                ...
                <select
                  ...
                  className="rounded-md border border-[#e5e5e5] bg-[#fafafa] px-2 py-1 text-xs font-semibold text-[#1d4ed8]"
                >
              ...
              <td className="px-4 py-3">
                <Link className="font-semibold text-[#1d4ed8] hover:text-[#3b82f6]" href={`/admin/leads/${String(lead.id)}`}>
                  Review case
                </Link>
              </td>
            </tr>
