...
export const demoLeads = [
  {
    ...
    reason_for_visit: "New patient intake for recurring migraines.",
    ...
    source: "landing_page",
    summary: "Patient provided core intake details and is ready for staff scheduling review.",
    created_at: now,
    updated_at: now,
  },
  {
    ...
    source: "landing_page",
    summary: "Clinical interpretation request was blocked and routed to human review.",
    created_at: now,
    updated_at: now,
  },
];
