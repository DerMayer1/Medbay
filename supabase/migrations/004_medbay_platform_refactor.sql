...
values
  ...
  ('pricing', 'Pricing policy', 'Pricing and insurance details are confirmed by staff. The AI assistant can collect payment type but cannot guarantee coverage.', true),
  ('schedule', 'Scheduling hours', 'Appointment slots are available Monday through Friday from 9:00 AM to 5:00 PM.', true),
